...
class G_index():
    ...
    def __init__(self, lamda, delta, num_test=1000, kind='PCA', num_simulation=100, mute=True, ID='normal'):
        ...
        self.data_generate = array([])
        self.num_test = num_test
        self.model = None
        self.time_try_generate = 0
    ...
    def check(self, x):
        ...
        if self.G_idx_last < self.G_idx_cur:
            ...
            self.data_store = x_
            self.time_try_generate = self.time_try_generate + 1
            return 'More Sample'
        else:
    ...
    def G_idx(self, x):
        ...
        R = v + self.lamda * e
        print(str(self.ID)+" var:"+str(v)+" error:"+str(e))
