...
def evaluate(x, y, name, window=10000):
    ...
    plt.legend()
    plt.savefig('result//'+str(name)+'performance_realtime.png')
    plt.cla()
    plt.clf()
    plt.close()
...
def overall(x, y, name):
    ...
    save("result//"+str(name)+"overall_result.npy", [temp1, temp2, temp3, temp4, temp5, temp6, temp7, temp8, temp_9, temp9])
